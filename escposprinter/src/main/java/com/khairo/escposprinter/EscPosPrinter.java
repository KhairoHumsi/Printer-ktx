...
import com.khairo.escposprinter.textparser.IPrinterTextParserElement;
import com.khairo.escposprinter.textparser.PrinterTextParser;
import com.khairo.escposprinter.textparser.PrinterTextParserColumn;
import com.khairo.escposprinter.textparser.PrinterTextParserLine;
import com.khairo.escposprinter.textparser.PrinterTextParserString;
import com.khairo.escposprinter.connection.DeviceConnection;
import com.khairo.escposprinter.exceptions.EscPosBarcodeException;
import com.khairo.escposprinter.exceptions.EscPosConnectionException;
import com.khairo.escposprinter.exceptions.EscPosEncodingException;
...
public class EscPosPrinter extends EscPosPrinterSize {
    ...
    public EscPosPrinter printFormattedText(String text, int dotsFeedPaper) throws EscPosConnectionException, EscPosParserException, EscPosEncodingException, EscPosBarcodeException {
        if (this.printer == null || this.getPrinterNbrCharactersPerLine() == 0) {
            return this;
        }
