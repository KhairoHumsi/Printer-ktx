...
import com.dantsu.escposprinter.textparser.PrinterTextParser.Companion.isTagTextFormat
import java.util.*
 ...
 */
class CoroutinesPrinterTextParserColumn(textParserLine: CoroutinesPrinterTextParserLine, oldTextColumn: String) {
    val line: CoroutinesPrinterTextParserLine
    var elements = arrayOfNulls<CoroutinesIPrinterTextParserElement>(0)
        private set

    private fun prependString(text: String): CoroutinesPrinterTextParserColumn {
    ...
    private fun prependImage(textAlign: String, hexString: String): CoroutinesPrinterTextParserColumn {
        return prependElement(CoroutinesPrinterTextParserImg(this, textAlign, hexString))
    }

    private fun appendImage(textAlign: String, hexString: String): CoroutinesPrinterTextParserColumn {
        return this.appendElement(CoroutinesPrinterTextParserImg(this, textAlign, hexString))
    }
    ...
    private fun prependQRCode(
        ...
        return prependElement(CoroutinesPrinterTextParserQRCode(this, textAlign, qrCodeAttributes, data))
    }
    ...
    private fun appendQRCode(
        ...
        return this.appendElement(CoroutinesPrinterTextParserQRCode(this, textAlign, qrCodeAttributes, data))
    }
